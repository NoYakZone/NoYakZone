...
const exampleData = [
    ...
    { id: 7, name: '필로폰', imageUrl: 'https://dimg.donga.com/wps/NEWS/IMAGE/2021/07/19/108030287.2.jpg', link: 'https://www.health.kr/Menu.PharmReview/View.asp?PharmReview_IDX=8535' },
    { id: 8, name: '마약', imageUrl: 'https://www.nhis.or.kr/magazin/151/html/style/images/sub3_img1.jpg', link: 'https://www.health.kr/Menu.PharmReview/View.asp?PharmReview_IDX=8501' },
    { id: 9, name: '덱스트로메토르판(Dextromethorphan)', imageUrl: dextromethorphan, link: 'https://www.health.kr/Menu.PharmReview/View.asp?PharmReview_IDX=8436' },
    { id: 10, name: '수면개선 일반의약품: 불면증의 개선이 필요할 때', imageUrl: 'https://jhealthfile.joins.com/photo/2018/03/30/133ed6a2823f2.jpg', link: 'http://www.health.kr/Menu.PharmReview/View.asp?PharmReview_IDX=8689' },
    { id: 11, name: '베타메타손(betamethasone): 아토피, 접촉피부염, 관절염 등의 치료가 필요할 때', imageUrl: betamethasone, link: 'http://www.health.kr/Menu.PharmReview/View.asp?PharmReview_IDX=8686' },
    { id: 12, name: '모기기피제 : 모기, 진드기, 벼룩 등 벌레 퇴치가 필요할 때', imageUrl: 'https://www.gangnam.go.kr/upload/editor/2022/06/14/8c5be9e9-a370-48df-8ef7-f2180026a34e.png', link: 'http://www.health.kr/Menu.PharmReview/View.asp?PharmReview_IDX=8683' },
    ...
    { id: 20, name: '가르시니아 캄보지아 추출물 : 체지방 감소에 도움이 필요할 때', imageUrl: garsinia, link: 'http://www.health.kr/Menu.PharmReview/View.asp?PharmReview_IDX=8660' },
    ...
    { id: 27, name: '아티반', imageUrl: ativan, link: 'https://www.health.kr/searchDrug/result_drug.asp?drug_cd=A11ABBBBB0914' },
    { id: 28, name: '페라미비르(peramivir)', imageUrl: noImage, link: 'http://www.health.kr/Menu.PharmReview/View.asp?PharmReview_IDX=8631' },
    { id: 29, name: '코데인(Codeine)', imageUrl: codeine, link: 'https://www.health.kr/searchIngredient/detail.asp?ingd_code=I005965' },
];
        ...
        <div>
            <Fade>
                ...
                <div className="about-description">
                    <p>우리의 사명은 마약 사용을 줄이고, 이를 통해 사회의 안전과 건강을 증진하는 것입니다.</p>
